...
rstudio - program to do something

# SYNOPSIS

**rstudio** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**rstudio** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **rstudio** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**rstudio** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    rstudio. See **foo.conf**(5) for further details.
...
**rstudio** provides some return codes, that can be used in scripts:
...
nfultz <nfultz@unknown>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 nfultz
